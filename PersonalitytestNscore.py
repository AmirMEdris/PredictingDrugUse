...
if __name__ == "__main__":
        qs = ['	Get stressed out easily.' ,'Am relaxed most of the time.'
    ,'Worry about things.','Seldom feel blue.'
    ,'Am easily disturbed.','Get upset easily.'
    ,'Change my mood a lot.',"Have frequent mood swings."
    ,"Get irritated easily.",'Often feel blue.']
        ...
        root.title('Ocean Survey: Neuroticism')
