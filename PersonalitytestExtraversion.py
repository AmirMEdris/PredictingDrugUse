...
def callback():
        ...
        X = sum(x) +30
        root.destroy()
        pkl.dump(X, open('EscoreTest.pkl', 'wb'))
...
if __name__ == "__main__":
        qs = ['Am the life of the party.' ,'Dont talk a lot.'
    ,'Feel comfortable around people.','Keep in the background.'
    ,'Start conversations.','Have little to say.'
    ,'Talk to a lot of different people at parties.',"Dont like to draw attention to myself."
    ,"Dont mind being the center of attention.",'Am quiet around strangers.']
        ...
        root.title('Ocean Survey: Extraversion')
